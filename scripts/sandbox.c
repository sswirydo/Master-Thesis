...
const char* timestamps_fmt[] = {
  "0097/Feb/16 --> 08:14:30", "YYYY/Mon/DD --> HH:MI:SS", // todo incorrect time
  ...
  // "05121445482000", "MMDDHH24MISSYYYY", // todo <------ does not work but should
  ...
  "Fri 1-Jan-1999", "DY DD MON YYYY",
  // -- Value clobbering:
  "1997-11-Jan-16", "YYYY-MM-Mon-DD",
  // -- Non-numeric input:
  "199711xy", "YYYYMMDD",
  // -- Input that doesn't fit in an int:
  "10000000000", "FMYYYY",
  // -- Out-of-range and not-quite-out-of-range fields:
  "2016-06-13 25:00:00", "YYYY-MM-DD HH24:MI:SS",
  "2016-06-13 15:60:00", "YYYY-MM-DD HH24:MI:SS",
  "2016-06-13 15:50:60", "YYYY-MM-DD HH24:MI:SS",
  "2016-06-13 15:50:55", "YYYY-MM-DD HH24:MI:SS", // -- ok
  "2016-06-13 15:50:55", "YYYY-MM-DD HH:MI:SS",
  "2016-13-01 15:50:55", "YYYY-MM-DD HH24:MI:SS",
  "2016-02-30 15:50:55", "YYYY-MM-DD HH24:MI:SS",
  "2016-02-29 15:50:55", "YYYY-MM-DD HH24:MI:SS", // -- ok
  "2015-02-29 15:50:55", "YYYY-MM-DD HH24:MI:SS",
  "2015-02-11 86000", "YYYY-MM-DD SSSS", // -- ok
  "2015-02-11 86400", "YYYY-MM-DD SSSS",
  "2015-02-11 86000", "YYYY-MM-DD SSSSS", // -- ok
  "2015-02-11 86400", "YYYY-MM-DD SSSSS",
};
...
void test_temp() 
{
    const char *date = "05 Dec 2024";
    const char *fmt = "DD Mon YYYY";
    printf("'%s', '%s' ", date, fmt);
    text *date_t = cstring2text(date);
    text *fmt_t = cstring2text(fmt);
    Timestamp ts = pg_to_timestamp(date_t, fmt_t);
