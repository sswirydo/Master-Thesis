...
pickup_type,drop_off_type) FROM '/home/szymon/Master-Thesis/data/gtfs/stop_times.txt' DELIMITER ','
CSV HEADER;
...
route_color,route_text_color) FROM '/home/szymon/Master-Thesis/data/gtfs/routes.txt' DELIMITER ','
CSV HEADER;
...
location_type,parent_station) FROM '/home/szymon/Master-Thesis/data/gtfs/stops.txt' DELIMITER ','
CSV HEADER;
